...
execFileSync('node', ['--test', 'tests/agent/loop.test.mjs', 'tests/agent/decomposition.test.mjs', 'tests/agent/state.test.mjs', 'tests/agent/step.test.mjs', 'tests/agent/workflow.test.mjs', 'tests/agent/escalation.test.mjs', 'tests/agent/surface.test.mjs', 'tests/agent/coverage.test.mjs', 'tests/agent/compare.test.mjs', 'tests/agent/live.test.mjs'],
