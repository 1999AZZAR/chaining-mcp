...
execFileSync('node', ['--test', 'tests/agent/loop.test.mjs', 'tests/agent/decomposition.test.mjs', 'tests/agent/state.test.mjs', 'tests/agent/step.test.mjs', 'tests/agent/workflow.test.mjs', 'tests/agent/escalation.test.mjs', 'tests/agent/diagnostics.test.mjs', 'tests/agent/guidance.test.mjs', 'tests/agent/skills.test.mjs', 'tests/agent/surface.test.mjs', 'tests/agent/coverage.test.mjs', 'tests/agent/compare.test.mjs', 'tests/agent/live.test.mjs', 'tests/agent/envelope.test.mjs', 'tests/agent/artifact.test.mjs', 'tests/agent/capability.test.mjs', 'tests/agent/needle3.test.mjs', 'tests/agent/http-adapter.test.mjs'],
