...
execFileSync('node', ['--test', 'tests/agent/loop.test.mjs', 'tests/agent/decomposition.test.mjs', 'tests/agent/state.test.mjs', 'tests/agent/workflow.test.mjs', 'tests/agent/live.test.mjs'],
